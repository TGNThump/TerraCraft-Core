...
public class Item {
	...
	public Integer getMinBaseDamage() {
		return minBaseDamage;
	}
	
	public Integer getMaxBaseDamage() {
	...
	public ForeignCollection<ItemInstance> getInstances() {
		return instances;
	}
	...
	public void setMinBaseDamage(Integer minBaseDamage) {
		this.minBaseDamage = minBaseDamage;
	}
	
	public void setMaxBaseDamage(Integer maxBaseDamage) {
	...
	public ItemInstance createInstance() {
		...
		instance.setCurDurability(getMaxDurability());
		
		Dao<ItemInstance, Integer> itemInstanceDao = ItemMechanicsV1.getInstance().getItemInstanceDao();
		try {
