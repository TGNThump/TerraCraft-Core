...
public class ARBoolean extends ARAbstractPrimitive<Boolean>{
	...
	public static final Set<String> TRUE_OPTIONS = new LinkedHashSet<String>(Arrays.asList(
			"y", "ye", "yes",
			"on",
			"t", "tr", "tru", "true"));
	
	public static final Set<String> FALSE_OPTIONS = new LinkedHashSet<String>(Arrays.asList(
			"n", "no",
			"of", "off",
			"f", "fa", "fal", "fals", "false"));
