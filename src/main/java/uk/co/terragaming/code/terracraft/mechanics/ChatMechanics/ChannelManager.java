...
public class ChannelManager {
	...
	public static Channel getChannel(Player sender, String name) {
		...
		for (Player player : Bukkit.getOnlinePlayers()) {
			...
			if (charName.equals(playerName) || charName.equals(terraTag)) {
				continue;
			}
	...
	public static Channel getWhisperChannel(Player sender, String recieverName, Player reciever, Integer nameLevel) {
		// If channel exists with name "whisper[senderName][recieverName]" or
		// other way round, return it;
		// Otherwise, create a new whisperChannel
		// "whisper[senderName][recieverName]" and return it;
