...
public class VanishPotionEffectManager {
	
	/**
	 * Copied Code from https://github.com/Skyost/ghost-player
	 */
	...
	public VanishPotionEffectManager(final Plugin plugin) {
		// Initialize
		createTask(plugin);
		createGetTeam();
	}
	...
	public void addPlayer(final Player player) {
		...
		if (!ghostTeam.hasPlayer(player)) {
			...
			// PotionEffect(PotionEffectType.INVISIBILITY, Integer.MAX_VALUE,
			// 15));
		}
	}
