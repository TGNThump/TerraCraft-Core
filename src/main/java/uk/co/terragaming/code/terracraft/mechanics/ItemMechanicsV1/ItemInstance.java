...
public class ItemInstance {
	...
	public String getColouredName() {
		if (getCurDurability() == 0) {
			...
			String color = ItemRarity.getChatColor(getQuality()).toString();
		...
		return Txt.parse(ItemRarity.getChatColor(getQuality()) + "<bold>" + getName() + "<r>");
	}
	...
	public ItemRarity getQuality() {
		if (quality == null)
			return getItem().getQuality();
		return quality;
	}
	...
	public Integer getMinModDamage() {
		return minModDamage;
	}
	
	public Integer getMaxModDamage() {
		return maxModDamage;
	}
	...
	public Integer getRawModStrength() {
		return modStrength;
	}
	
	public Integer getRawModAgility() {
		return modAgility;
	}
	
	public Integer getRawModStamina() {
		return modStamina;
	}
	
	public Integer getRawModSpirit() {
		return modSpirit;
	}
	
	public Integer getRawModResistance() {
		return modResistance;
	}
	
	public Integer getRawModIntellect() {
		return modIntellect;
	}
	
	public Integer getRawModVitality() {
		return modVitality;
	}
	
	public Integer getModStrength() {
		return modStrength + getItem().getModStrength();
	}
	
	public Integer getModAgility() {
		return modAgility + getItem().getModAgility();
	}
	
	public Integer getModStamina() {
		return modStamina + getItem().getModStamina();
	}
	
	public Integer getModSpirit() {
		return modSpirit + getItem().getModSpirit();
	}
	
	public Integer getModResistance() {
		return modResistance + getItem().getModResistance();
	}
	
	public Integer getModIntellect() {
		return modIntellect + getItem().getModIntellect();
	}
	
	public Integer getModVitality() {
		return modVitality + getItem().getModVitality();
	}
	...
	public void setQuality(ItemRarity quality) {
	...
	public void setBoundCharacter(Character boundCharacter) {
		this.boundCharacter = boundCharacter;
	}
	
	public void setBoundAccount(Account boundAccount) {
		this.boundAccount = boundAccount;
	}
	
	public void setMinModDamage(Integer minModDamage) {
		this.minModDamage = minModDamage;
	}
	
	public void setMaxModDamage(Integer maxModDamage) {
		this.maxModDamage = maxModDamage;
	}
	...
	public void setModAgility(Integer modAgility) {
		this.modAgility = modAgility;
	}
	
	public void setModStamina(Integer modStamina) {
		this.modStamina = modStamina;
	}
	
	public void setModSpirit(Integer modSpirit) {
		this.modSpirit = modSpirit;
	}
	
	public void setModResistance(Integer modResistance) {
		this.modResistance = modResistance;
	}
	
	public void setModIntellect(Integer modIntellect) {
		this.modIntellect = modIntellect;
	}
	
	public void setModVitality(Integer modVitality) {
		this.modVitality = modVitality;
	}
	...
	public ItemStack getItemStack() {
		if (getItem().getId() == 0) {
			...
			item.addLore(ChatColor.GRAY + (getItem().getItemClass().equals(ItemClass.MELEE) || getItem().getItemClass().equals(ItemClass.RANGE) ? Txt.upperCaseFirst(getItem().getItemClass().toString().toLowerCase()) + " Weapon" : Txt.upperCaseFirst(getItem().getItemClass().toString().toLowerCase())) + "                              " + ChatColor.GOLD + getItem().getType().toString());
			...
			if (getCurDurability() == 0) {
				...
				// Durability is weird... 0 is fully repaired,
				// getMaxDurability() is fully broken.
				double maxDamage = getMaterial().getMaxDurability();
