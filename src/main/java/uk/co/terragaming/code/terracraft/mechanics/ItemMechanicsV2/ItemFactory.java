...
import uk.co.terragaming.code.terracraft.mechanics.ItemMechanicsV1.ItemRegistry;
...
//	}
	...
	public static Item randomItem(){
		List<uk.co.terragaming.code.terracraft.mechanics.ItemMechanicsV1.Item> items = Lists.newArrayList(ItemRegistry.items.values());
		uk.co.terragaming.code.terracraft.mechanics.ItemMechanicsV1.Item i = items.get(MathUtils.randInt(0, items.size() - 1));
