			...
			switch(ban.getType()){
				...
				case TEMP:
					...
					PeriodFormatterBuilder Formater = new PeriodFormatterBuilder()
						.appendPrefix(Lang.get(account.getLanguage(), "accountTempBan"))
						.appendDays().appendSeparator(Lang.get(account.getLanguage(), "accountTempBanDays"))
						.appendHours().appendSeparator(Lang.get(account.getLanguage(), "accountTempBanHours"))
						.appendMinutes().appendSeparator(Lang.get(account.getLanguage(), "accountTempBanMinutes"))
						.appendSeconds().appendPrefix(Lang.get(account.getLanguage(), "accountTempBanSeconds"));
