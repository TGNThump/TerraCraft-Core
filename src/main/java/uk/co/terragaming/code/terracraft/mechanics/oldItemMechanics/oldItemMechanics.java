...
import uk.co.terragaming.code.terracraft.mechanics.oldItemMechanics.commands.StaffItemCommands;
import uk.co.terragaming.code.terracraft.mechanics.oldItemMechanics.events.ItemBindEvents;
import uk.co.terragaming.code.terracraft.mechanics.oldItemMechanics.events.ItemEvents;
import uk.co.terragaming.code.terracraft.mechanics.oldItemMechanics.events.ItemUseEvents;
...
public class oldItemMechanics implements Mechanic {
	...
	public static oldItemMechanics getInstance() {
		return (oldItemMechanics) TerraCraft.getMechanic("oldItemMechanics");
	}
