...
import uk.co.terragaming.code.terracraft.mechanics.ItemMechanicsV2.ItemHistory;
import uk.co.terragaming.code.terracraft.mechanics.ItemMechanicsV2.ItemMechanicsV2;
...
public abstract class Item {
	...
	public ItemStack render(){
		...
		AttributeStorage storage = AttributeStorage.newTarget(item.getItemStack(), ItemMechanicsV2.getInstance().getAttributeUUID());
	...
	public String getColouredName(){
		if (isBroken()){
			...
			String color = ItemRarity.getChatColor(getRarity()).toString();
		...
		return ItemRarity.getChatColor(getRarity()) + "<bold>" + getName() + "<r>";
	}
