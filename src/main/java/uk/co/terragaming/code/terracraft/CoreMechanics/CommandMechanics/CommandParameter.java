...
public class CommandParameter {
	...
	private boolean isNamed = false; // Reflection cannot get names when not compiled with java 8
	private boolean isSpecial = false; // Special parameters are assigned automatically, no arguments required
	...
	public AR<?> getArgReader(){ return argReader; }
	...
	public void setType(Class<?> type) throws TerraException{
		...
		try {
			...
			this.argReader = (AR<?>) arClass.newInstance();
